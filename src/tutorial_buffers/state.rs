...
use winit::{event::WindowEvent, event::*, window::Window};
    ...
    pub fn input(&mut self, event: &WindowEvent) -> bool {
        match event {
            WindowEvent::KeyboardInput {
                ...
                self.in_challenge_mode = !self.in_challenge_mode;
                println!("in challenge mode {:}", self.in_challenge_mode);
                if (self.in_challenge_mode) {
                    self.num_indices = CHALLENGE_INDICES.len() as u32;
                } else {
