use crate::tutorial_textures::texture;
...
impl State {
    ...
    pub async fn new(window: Window) -> Self {
        ...
        let challenge_diffuse_bytes = include_bytes!("coin.png"); // CHANGED!
        let challenge_diffuse_texture =
            texture::Texture::from_bytes(&device, &queue, challenge_diffuse_bytes, "coin.png").unwrap(); // CHANGED!
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            if !self.in_challenge_mode {
                ...
                render_pass.set_bind_group(0, &self.challenge_bind_group, &[]); // NEW!
            }
