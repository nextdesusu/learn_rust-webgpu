...
impl State {
    ...
    pub fn input(&mut self, event: &WindowEvent) -> bool {
        match event {
            WindowEvent::KeyboardInput {
                ...
                self.is_challenge_shader = !self.is_challenge_shader;
                true
            }
            _ => false,
        }
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            if (self.is_challenge_shader) {
                render_pass.set_pipeline(&self.challenge_pipeline); // 2.
            } else {
