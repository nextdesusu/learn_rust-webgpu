...
fn main() -> Result<()> {
    let current_project_name = "tutorial_model_loading";
    let current_project_res_path = format!("src/{}/res/", current_project_name);
    ...
    let paths_to_copy = vec![current_project_res_path];
